...
t_scene	*scene_init(void)
{
	...
	object_add(&objects, object(SPHERE, sphere(point3(0.0, 0.0, -1.0), 0.5), color3(0.1, 0.2, 0.5), checker(FALSE, color3(0,0,0), color3(0,0,0))));
	object_add(&objects, object(SPHERE, sphere(point3(-1.0, 0.0, -1.0), 0.5), color3(0.8, 0.8, 0.1), checker(TRUE, color3(0.2, 0.3, 0.1), color3(0.9, 0.9, 0.9))));
	...
	lights = object(LIGHT_POINT, light_point(point3(0, 20, 0), color3(1, 1, 1), 0.2), color3(0, 0, 0), checker(FALSE, color3(0,0,0), color3(0,0,0)));
	scene->lights = lights;
	ka = 0.1;
